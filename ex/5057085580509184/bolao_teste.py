...
elif realA > realB and palpiteA > palpiteB and palpiteA == realA or palpiteB == realB:
    print(3)

elif realB > realA and palpiteB > palpiteA and palpiteB == realB or palpiteA == realA:
    print(3)
